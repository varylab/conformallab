...
public class EuclideanUnwrapperPetscTest {
	...
	@Test
	public void testStaticUnwrapWithCircularEdges() throws Exception {
		ReaderOBJ reader01 = new ReaderOBJ();
		...
		List<int[]> circularEdges = new LinkedList<int[]>();
		...
		Assert.assertEquals(texArr[514][0], 0.0, 1E-7);
		Assert.assertEquals(texArr[514][1], 0.0, 1E-7);
	}
	...
	public static void main(String[] args) throws Exception {
		...
		test.testStaticUnwrapWithCircularEdges();
