...
public class ConformalEuclideanCirclesTest extends FunctionalTest<CoVertex, CoEdge, CoFace> {
	...
	public void init() {
		...
		CoHDS hds = new CoHDS(); 
		try {
			Input in = new Input("Obj File", ConformalEuclideanCirclesTest.class.getResourceAsStream("cathead.obj"));
			c =reader.read(in);
